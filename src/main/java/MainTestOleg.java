...
public class MainTestOleg {
    static final String DB_CONNECTION = "jdbc:mysql://localhost:3306/oledb?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
        ...
        try {
            try {
                ...
                while (true) {
                    ...
                    System.out.println("7: select employee by salary");
                    System.out.print("-> ");
    ...
    private static void initDB() throws SQLException {
        ...
        try {
            ...
            st.execute("CREATE TABLE Employees (id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, name VARCHAR(20) NOT NULL, age INT, salary INT)");
        } finally {
            st.close();
        }
    }
    ...
    private static void addEmployees(Scanner sc) throws SQLException {
    ...
    private static void selectEmployees(Scanner sc) throws SQLException {
        System.out.print("Enter employee salary: ");
        String sSalary = sc.nextLine();
        int salary = Integer.parseInt(sSalary);
